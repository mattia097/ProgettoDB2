	...
	<form name="form-registration" id="form-registration"
		...
		<table id="tab-registration">
			...
			<tr>
				...
				<td><input type="password" name="field-check-psw" id="check-password"></td>
			</tr>
			<tr>
			...
			<tr>
				<td>
				<label>Sesso</label></td>
				<td>
					<label for="male">Male</label> 
					<input type="radio"	name="field-sex" id="male" value="male"> 
					
					<label for="female">Female</label>
					<input type="radio" name="field-sex" id="female" value="female">
			...
			<tr>
				<td colspan="2"><input type="submit" value="Registrati" onclick="return checkPasswordEquivalence()"></td>
			</tr>
		</table>
	</form>
</body>

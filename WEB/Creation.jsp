...
<body>
	...
	<form id="form-create-product" action="/ProgettoDB2_WEB/CreateProduct"
		method="post">
		<table id="tab-insert-product">
			...
			<tr>
				...
				<td><label>date: (yyyy-mm-dd) </label> <input type="date" name="field-date"
					id="field-date"></td>
	...
	<form id="form-modify-product" action="/ProgettoDB2_WEB/ModifyProductDate"
		method="post">
